...
function Kategoripage() {
	...
	useEffect(() => {
		...
		axios
			.get(`http://localhost:4242/products/category/${currentKategori}`)
			...
			<article className={style.mainArticle}>
				<ul>
					...
					<li
						value=""
						onClick={() => {
							setCurrentKategori("have-og-byg");
						}}
					>
						Have og byg
					</li>
					<li
						value=""
						onClick={() => {
							setCurrentKategori("toej-og-mode");
						}}
					>
						Tøj og mode
					</li>
					...
					<li
						value=""
						onClick={() => {
							setCurrentKategori("mobil-og-telefoni");
						}}
					>
						Mobil og telefoni
					</li>
					<li
						value=""
						onClick={() => {
							setCurrentKategori("musik-instrumenter");
						}}
					>
						Musik instrumenter
					</li>
					<li
						value=""
						onClick={() => {
							setCurrentKategori("billede-og-lyd");
						}}
					>
						Billede og lyd
					</li>
					<li
						value=""
						onClick={() => {
							setCurrentKategori("scootere-og-knallerter");
						}}
					>
						Scooter og knallerter
					</li>
					<li
						value=""
						onClick={() => {
							setCurrentKategori("boeger-og-blade");
						}}
					>
						Bøger og Blade
					</li>
